      ...
      <div className="hero-container">
        <div className="hero-content">
          <div className="hero-logo">
            <img src={logoUrl} alt="CodixVerse Icon" className="hero-logo-img" />
          </div>
          <h1 className="hero-title">
            <span>CodixVerse</span>
          </h1>
          <p className="hero-description">
            We are a team of professional developers specializing in application and website development
            with the latest technologies and best practices in the world of programming
          </p>
